...
# Explicación de las lineas del comado docker run
# 1. Ejecuta el contenedor en segundo plano
# 2. Se reiniciará automáticamente si se detiene
# 3. Mapea puerto local 5001 → puerto 5000 del registro
# 4. Nombre del contenedor
# 5. Imagen oficial del registro Docker
